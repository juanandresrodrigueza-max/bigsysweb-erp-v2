...
class StockController extends Controller
{
    ...
    public function show(int $id, Request $request)
    {
        ...
        return Inertia::render('Stock/Ver', [
            'p' => $p->only('id', 'name', 'sku', 'tipo', 'barcode', 'marca', 'description', 'unit', 'active', 'controla_stock', 'rubro_id', 'proveedor_id', 'stock_min', 'iva', 'perecedero', 'seriado', 'garantia_meses', 'control_turno') + [
