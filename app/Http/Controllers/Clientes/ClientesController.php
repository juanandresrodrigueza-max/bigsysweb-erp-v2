...
class ClientesController extends Controller
{
    ...
    public function guardar(Request $request, ?int $id = null)
    {
        ...
        $data = $request->validate([
            ...
            'descuento' => 'nullable|numeric|min:0|max:100', 'percepcion_iibb' => 'boolean', 'percepcion_iva' => 'boolean', 'percepcion_ganancias' => 'boolean', 'is_active' => 'boolean', 'notes' => 'nullable|string|max:2000',
        ]);
