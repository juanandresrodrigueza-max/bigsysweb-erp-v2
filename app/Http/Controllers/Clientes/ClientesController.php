...
class ClientesController extends Controller
{
    ...
    public function guardar(Request $request, ?int $id = null)
    {
        ...
        $data = $request->validate([
            ...
            'descuento' => 'nullable|numeric|min:0|max:100', 'percepcion_iibb' => 'boolean', 'percepcion_iva' => 'boolean', 'percepcion_ganancias' => 'boolean', 'pais_codigo' => 'nullable|string|max:4', 'cuit_pais' => 'nullable|string|max:15', 'id_impositivo' => 'nullable|string|max:40', 'is_active' => 'boolean', 'notes' => 'nullable|string|max:2000',
        ]);
