...
class BackupService
{
    ...
    public const TABLAS = [
        ...
        'precios_pactados', 'catalogos', 'descuentos_lista', 'contacto_personas', 'documentos', 'empleados', 'empleado_conceptos', 'sueldo_conceptos', 'liquidaciones', 'liquidacion_items'
    ];
