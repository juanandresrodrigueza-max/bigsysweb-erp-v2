...
class BackupService
{
    ...
    public function crear(Business $b, string $origen = 'manual', ?int $userId = null): Backup
    {
        ...
        foreach (['adjuntos', "afip/{$b->id}", "logos"] as $carpeta) {
    ...
    {
        $padres = ['comprobante_items' => ['comprobantes', 'comprobante_id'], 'comprobante_impuestos' => ['comprobantes', 'comprobante_id'], 'comprobante_adjuntos' => ['comprobantes', 'comprobante_id'], 'cobro_medios' => ['cobros', 'cobro_id'], 'cobro_imputaciones' => ['cobros', 'cobro_id'], 'pago_medios' => ['pagos', 'pago_id'], 'pago_imputaciones' => ['pagos', 'pago_id'],
