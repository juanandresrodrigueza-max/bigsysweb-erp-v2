...
class MovimientoFondos extends Model
{
    ...
    protected $fillable = ['business_id', 'cuenta_fondos_id', 'user_id', 'turno_caja_id', 'fecha', 'origen', 'origen_id', 'expense_category_id', 'concepto', 'ingreso', 'egreso', 'referencia', 'conciliado'];
