...
{
    protected $fillable = ['comprobante_id', 'product_id', 'descripcion', 'cantidad', 'unidad', 'precio_unit', 'costo_unit', 'descuento', 'alicuota_iva', 'neto', 'iva', 'total', 'orden', 'cantidad_entregada', 'cantidad_facturada', 'origen_item_id', 'lote', 'vencimiento', 'serie'];
