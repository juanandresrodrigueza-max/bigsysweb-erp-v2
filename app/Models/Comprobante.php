...
class Comprobante extends Model
{
    ...
    protected $fillable = [
        ...
        'cae', 'cae_vto', 'afip_respuesta', 'es_acopio', 'receptor', 'stock_impactado', 'notas', 'pdf_path', 'emitido_en', 'anulado_en', 'offline_id', 'crm_quote_id',
        'numero_proveedor', 'cae_proveedor', 'origen_carga', 'total_me', 'neto_me', 'proyecto_id', 'orden_trabajo_id', 'estadia_id', 'transportista', 'transportista_cuit', 'patente', 'bultos', 'peso_kg', 'domicilio_entrega', 'cot', 'sin_arca', 'exportacion', 'manual', 'cai', 'cai_vto',
    ];
    ...
    protected $casts = [
        ...
        'descuento' => 'decimal:2', 'total' => 'decimal:2', 'saldo' => 'decimal:2', 'cotizacion' => 'decimal:4', 'sin_arca' => 'boolean', 'exportacion' => 'array', 'manual' => 'boolean', 'cai_vto' => 'date',
    ];
    ...
    // Comprobantes que van a los libros de IVA y a ARCA: excluye los internos (sin_arca).
    public function scopeFiscales(Builder $q): Builder { return $q->where('sin_arca', false); }
    public function esInterno(): bool { return (bool) $this->sin_arca; }
