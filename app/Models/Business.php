...
class Business extends Model
{
    ...
    protected $casts = ['marca' => 'array', 'inicio_actividades' => 'date', 
        'verticales_extra' => 'array', 'sueldos' => 'array', 'lotes_config' => 'array', 'rentabilidad' => 'array', 'tarjetas' => 'array',
        'is_active'            => 'boolean',
        'recordatorios'        => 'array',
        'impuestos'            => 'array',
        'onboarding'           => 'array',
